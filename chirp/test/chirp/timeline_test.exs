defmodule Chirp.TimelineTest do
  ...
  describe "post" do
    ...
    @valid_attrs %{body: "some body", likes_count: 42, posts: "some posts", reposts_count: 42, username: "some username"}
    @update_attrs %{body: "some updated body", likes_count: 43, posts: "some updated posts", reposts_count: 43, username: "some updated username"}
    ...
    test "update_post/2 with valid data updates the post" do
      ...
      assert post.posts == "some updated posts"
